...
typedef SolverStatus (*SolverInitFunc)(Solver* solver, const Grid* grid, const SolverParams* params);
...
typedef double (*SolverComputeDtFunc)(Solver* solver, const FlowField* field,
