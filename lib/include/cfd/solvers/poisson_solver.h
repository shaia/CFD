...
typedef enum {
    ...
    POISSON_SOLVER_JACOBI_SIMD_OMP = 1,  /**< Jacobi method with SIMD+OMP backend (runtime detection) */
    POISSON_SOLVER_REDBLACK_SIMD_OMP = 2 /**< Red-Black SOR with SIMD+OMP backend (runtime detection) */
} poisson_solver_type;
